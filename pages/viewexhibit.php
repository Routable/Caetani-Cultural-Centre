...
$categorysql   = "SELECT * FROM CATEGORY, CATEGORY_EXHIBITS
WHERE CATEGORY.CATEGORY_ID = CATEGORY_EXHIBITS.CATEGORY_ID
AND CATEGORY_EXHIBITS.EXHIBIT_ID =" . $id;
$categoryquery = mysqli_query($mysqli, $categorysql);
if (!$categoryquery) {
    die('SQL error: ' . mysqli_error($mysqli));
}
...
echo strip_tags($extitle,'<h1><h2><h3><h4></h1></h2></h3></h4></p><p><br></br><img><a>');
?></div>
    </div>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body"><?php
echo strip_tags($exdescription,'<h1><h2><h3><h4></h1></h2></h3></h4></p><p><br></br><img><a>');
?></div>
    </div>

    <?php
      if($exot != "" || $exod != ""){
       $otherfield = '<div class="panel panel-primary">
              <div class="panel-heading">'.$exot.'</div>
              <div class="panel-body">'.$exod.'</div>
            </div>';
            echo strip_tags($otherfield, '<h1><h2><h3><h4></h1></h2></h3></h4></p><p><br></br><img><a><div>');
      }
     ?>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body"><?php
echo strip_tags($artistname,'<h1><h2><h3><h4></h1></h2></h3></h4></p><p><br></br><img><a>');
?></div>
    </div>
...
if ($result->num_rows > 1) {
  ...
  while ($row = mysqli_fetch_array($result)){
  echo '<img src='. strip_tags($row['PATH'], '<h1><h2><h3><h4></h1></h2></h3></h4></p><p><br></br><img><a>') . ' class="img-thumbnail center-block img-responsive">';
  }
} else{
  echo '<div class="panel-body">No Images</div>';
}
?>
...
<!-- PHP QUERY FOR SPITTING OUT THE CATEGORY -->
<?php
if($categoryname != NULL && $categoryname != "") {
echo '<div class="panel panel-primary"><div class="panel-heading">Category</div><div class="panel-body">';
echo strip_tags($categoryname);
echo '</div></div>';
}
?>
